...
| F20 | **تصدير سجل الطلاب إلى Excel:** زر "📤 تصدير Excel" في dashboard يصدّر كل الطلاب (يشمل المؤرشفين) بأعمدة الشاشة (#، الاسم، الجوال، جوال 2، المرحلة، المصدر، البرامج، أول تواصل، الحالة)، جوالات كنص، تواريخ هجرية، ورقة RTL | ✅ | 2026-07-08 | PR #2 (`63c4802`) |
